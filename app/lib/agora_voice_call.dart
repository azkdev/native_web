...
class CallPageVoice extends StatefulWidget {
  ...
  const CallPageVoice(
      {Key key, this.channelName, this.args, this.webviewPlugin})
      : super(key: key);

  @override
  _CallPageVoiceState createState() {
    return _CallPageVoiceState();
  }
}

class _CallPageVoiceState extends State<CallPageVoice> {
  ...
  void initialize() async {
    if (cfg.configs['agora_id'].isEmpty) {
      setState(() {
        _infoStrings
  ...
  Future<void> _initAgoraRtcEngine() async {
    AgoraRtcEngine.create(cfg.configs['agora_id']);
  ...
  /// Create a native view and add a video session object
  ...
  void _onCallEnd(BuildContext context) async {
    await widget.webviewPlugin?.show();
  ...
  Widget build(BuildContext context) {
    widget.webviewPlugin?.hide();
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.white,
        title: Text(
          'Declaration Voice Call',
          style: TextStyle(
